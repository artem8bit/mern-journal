...
export const PostPage = () => {
	...
	return (
		<div>
			<button className="flex justify-center items-center bg-gray-400 rounded-sm py-2 px-4">
			...
			<div className="flex justify-center gap-10 py-8">
				<div className="w-2/3">
					<div className="flex flex-col basis-1/4 flex-grow">
						<div
							className={post?.ImgUrl ? "flex rounded-sm h-80" : "flex rounded"}
						>
							{post?.imgUrl && (
								<img
					...
					<div className="text-xs pt-4">{post.text}</div>
			...
			<div className=" w-2/3   p-8 flex flex-col  gap-2 rounded-sm ">
					<form className="flex gap-2" onSubmit={(e) => e.preventDefault()}>
						<input
							...
							placeholder="Comment"
							className="text-white w-1/3 rounded-sm bg-gray-400 border p-2 text-xs outline-none placeholder:text-gray-200"
						/>
						<button
							type="submit"
